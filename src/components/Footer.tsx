        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            ...
            <p className="text-primary-foreground/70 text-sm leading-relaxed">
              Jasa pembuatan website profesional yang fokus menaikkan omset
              bisnis Anda melalui teknologi digital terkini.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              {["Home", "Services", "Portfolio", "Pricing", "Testimonials"].map(
                (l) => (
                  <Link
                    key={l}
